    ...
    <>
      ...
      {alertOpen ? (
        <Grid className={classes.alertContainer} container item>
          <Grid item>
            <FailedAlert message="体組成を記録できませんでした" />
          </Grid>
        </Grid>
      ) : null}
      <Hidden xsDown>
      ...
      <Hidden smUp>
        <Typography className={classes.sfTitle} variant="h6">
          体組成記録
        </Typography>
      </Hidden>
      <Grid className={classes.lineChartsContainer} container item>
        <Hidden mdDown>
          <LineChart width={1000} height={300} data={formatedBodyCompositions}>
        ...
        <Hidden lgUp xsDown>
          <LineChart width={700} height={300} data={formatedBodyCompositions}>
            <XAxis dataKey="created_at" interval={2} />
            <YAxis
              yAxisId="left"
              label={{ value: "体重(kg)", dx: -10, angle: -90 }}
        ...
        <Hidden smUp>
          <LineChart width={350} height={300} data={formatedBodyCompositions}>
      ...
      <Hidden smUp>
        <Grid
          className={classes.sfSubmitArea}
          container
          item
          direction="column"
          alignItems="center"
