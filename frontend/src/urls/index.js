...
export const showUserPage = (userId) => `${process.env.REACT_APP_SERVER_URL}/users/${userId}`;
export const userUpdate =  (userId) => `${process.env.REACT_APP_SERVER_URL}/users/${userId}`;
...
export const showQuestionUrl = (questionId) => `${process.env.REACT_APP_SERVER_URL}/questions/${questionId}`;
export const postAdviceUrl = `${process.env.REACT_APP_SERVER_URL}/advices`;
export const hundleBookmarkUrl = (adviceId) => `${process.env.REACT_APP_SERVER_URL}/advices/${adviceId}/bookmarks`;
...
export const hundleFollowUrl = (userId) => `${process.env.REACT_APP_SERVER_URL}/users/${userId}/relationships`;
export const showFollowingsUrl = (id) => `${process.env.REACT_APP_SERVER_URL}/users/${id}/follows`;
export const showFollowersUrl = (id) => `${process.env.REACT_APP_SERVER_URL}/users/${id}/followers`;
export const getTrainingLogsUrl = `${process.env.REACT_APP_SERVER_URL}/training_logs`;
export const hundleTrainingLogsUrl = (id) => `${process.env.REACT_APP_SERVER_URL}/training_logs/${id}`;
export const hundleQuestionsUrl = (id) => `${process.env.REACT_APP_SERVER_URL}/questions/${id}`;
export const hundleAdivceUrl = (id) => `${process.env.REACT_APP_SERVER_URL}/advices/${id}`;
export const showTrainingLogUrl = (id) => `${process.env.REACT_APP_SERVER_URL}/training_logs/${id}`;
